...
const TELEGRAM_REVIEWS_URL = 'https://t.me/your_reviews_channel';

interface ReviewsPageProps {
  city?: City;
}

const ReviewsPage: React.FC<ReviewsPageProps> = ({ city }) => {
  return (
      ...
      <section className="reviews-hero">
        <div className="container">
          <div className="hero-content">
            ...
            <h1>Что говорят наши клиенты {city ? `в ${city.name}` : ''}</h1>
            <p>Подборка реальных отзывов {city ? `о натяжных потолках в ${city.namePrepositional}` : ''}. Ещё больше — в нашем Telegram‑канале.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="cta">
            ...
            <div className="actions">
              <a href="tel:+79180000000" className="btn-primary">Позвонить</a>
