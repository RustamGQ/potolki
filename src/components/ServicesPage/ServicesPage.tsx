...
const ServicesPage: React.FC<ServicesPageProps> = ({ city }) => {
  return (
      ...
      <section className="services-hero">
        <div className="container">
          <div className="hero-content">
            ...
            <h1>Цены на натяжные потолки {city ? `в ${city.name}` : ''}</h1>
            <p>Актуальные цены на все виды натяжных потолков {city ? `в ${city.namePrepositional}` : ''}. Закупочная цена + наша наценка за монтаж и материалы.</p>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <div className="cta-actions">
              <a href="tel:+79180000000" className="btn-primary-large">Заказать бесплатный замер</a>
